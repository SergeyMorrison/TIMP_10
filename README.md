...
Далее нужно скачать библиотеку .homestead (в данном репозитории она есть в файлах) и перенести в домашнюю библиотеку пользователя "C:\Users\"Имя пользователя"" (данный путь далее заменяю ~/)
